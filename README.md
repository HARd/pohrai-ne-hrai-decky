# VARTA для Decky Loader (🇺🇦 Українською)
...
Оригінальне розширення:
[POHRAI/NE HRAI Chrome Extension](https://chromewebstore.google.com/detail/pohraine-hrai-steam-devel/mcmmldkegalnagpcokhkppcpjecfcfje)
